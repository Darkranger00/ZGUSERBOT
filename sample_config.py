...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Zazbhai/ZGUSERBOT"
    )
    # External plugins repo
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/Zazbhai/tha_plugins"
    else:
        EXTERNAL_REPO = None
    # if you need badcat plugins use the following vars
    ZGABUSE = os.environ.get("ZGABUSE", False)
    ZGABUSE = bool(ZGABUSE and (ZGABUSE.lower() != "false"))
    # for vc plugins
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "ZGBOT")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/9e2f854ed7b16df90992d.jpg"
    )
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-ZGBOT-01-01
    ...
    TG_2STEP_VERIFIZGSION_CODE = os.environ.get("TG_2STEP_VERIFIZGSION_CODE", None)
    ...
    ZGABUSE_REPO = os.environ.get("ZGABUSE_REPO", "https://github.com/Zazbhai/tha_plugins")
    if ZGABUSE_REPO and not url(ZGABUSE_REPO):
        ZGABUSE_REPO = "https://github.com/Zazbhai/tha_plugins"
    ZGABUSE_REPOBRANCH = os.environ.get("ZGABUSE_REPOBRANCH", "ZGABUSE")
