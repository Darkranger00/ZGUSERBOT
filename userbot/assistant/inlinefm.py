...
# BACK
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmback"))
@check_owner
...
# UP
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmup_(.*)"))
@check_owner
async def up(event):
...
# DOWN
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmdown_(.*)"))
@check_owner
...
# FORTH
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmforth_(.*)"))
@check_owner
...
# REMOVE
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmrem_(.*)"))
@check_owner
...
# SEND
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmsend"))
@check_owner
...
# CUT
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmcut_(.*)"))
@check_owner
async def cut(event):
...
# COPY
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmcopy_(.*)"))
@check_owner
...
# PASTE
@ZGBOT.tgbot.on(CallbackQuery(pattern="fmpaste_(.*)"))
@check_owner
