...
@ZGBOT.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@ZGBOT.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@ZGBOT.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
