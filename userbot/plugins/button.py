...
# button post makker for ZGBOT thanks to uniborg for the base
...
from . import ZGBOT, edit_delete, reply_id
...
@ZGBOT.zazbhai_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [ZGBOT]<buttonurl:https://t.me/ZGBOTSSS17:same> [support]<buttonurl:https://t.me/ZGBOTSSS_support>",
    },
)
async def _(event):
...
@ZGBOT.zazbhai_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [ZGBOT]<buttonurl:https://t.me/ZGBOTSSS17:same> [support]<buttonurl:https://t.me/ZGBOTSSS_support>",
    },
)
async def _(event):
