...
@ZGBOT.zazbhai_cmd(
    ...
    info={
        ...
        "examples": "{tr}admins @zgbotsupport",
    },
)
async def _(event):
...
@ZGBOT.zazbhai_cmd(
    ...
    info={
        ...
        "examples": "{tr}chatinfo @zgbotsupport",
    },
)
...
@ZGBOT.zazbhai_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}grpstats @zgbotsupport",
            "{tr}grpstats -q2000 @zgbotsupport",
            "{tr}grpstats -l20 @zgbotsupport",
            "{tr}grpstats -s @ZGBOTot",
            "{tr}grpstats -s -l20 -q2000 @ZGBOTot",
        ],
    },
)
