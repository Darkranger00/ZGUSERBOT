...
from userbot import Convert, ZGBOT
...
async def very(event):  # sourcery no-metrics
    ...
    LOGO_BACKGROUND = loader2 = (
        ...
        or "https://github.com/Zazbhai/ZGUSERBOT-Resources/raw/master/Resources/Logo/Background/black.jpg"
    )
    LOGO_FONT = loader3 = (
        gvarstatus("LOGO_FONT")
        or "https://github.com/Zazbhai/ZGUSERBOT-Resources/blob/master/Resources/Logo/Fonts/Streamster.ttf?raw=true"
    )
    rcheck = random_checker(LOGO_FONT, LOGO_FONT_COLOR, LOGO_BACKGROUND)
    if rcheck:
        rjson = requests.get(
            "https://raw.githubusercontent.com/TgZGBOT/ZGBOT-Resources/master/Resources/Logo/resources.txt"
        ).json()
...
async def bad(event):
    ...
    string = (
        ...
        else f"https://github.com/Zazbhai/ZGUSERBOT-Resources/raw/master/Resources/Logo/Background/{input_str}.jpg"
    )
...
async def pussy(event):  # sourcery no-metrics
    ...
    if cmd == "":
        source = requests.get(
            "https://github.com/Zazbhai/ZGUSERBOT-Resources/tree/master/Resources/Logo/Fonts"
        )
        ...
        if input_str != "Random":
            ...
            string = f"https://github.com/Zazbhai/ZGUSERBOT-Resources/blob/master/Resources/Logo/Fonts/{input_str}.ttf?raw=true"
