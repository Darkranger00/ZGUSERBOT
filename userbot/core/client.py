...
class ZGBOTClient(TelegramClient):
    def zazbhai_cmd(
        self: TelegramClient,
...
ZGBOTClient.fast_download_file = download_file
ZGBOTClient.fast_upload_file = upload_file
ZGBOTClient.reload = restart_script
ZGBOTClient.get_msg_link = get_message_link
ZGBOTClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    ZGBOTClient.send_message = send_message
    ZGBOTClient.send_file = send_file
    ZGBOTClient.edit_message = edit_message
